...
mvn install:install-file -DgroupId=com.alibaba.fastsql -DartifactId=fastsql -Dversion=2.0.0_preview_540 -Dpackaging=jar -DpomFile=fastsql-2.0.0_preview_540.pom -Dfile=fastsql-2.0.0_preview_540.jar -Dsources=fastsql-2.0.0_preview_540-sources.jar
